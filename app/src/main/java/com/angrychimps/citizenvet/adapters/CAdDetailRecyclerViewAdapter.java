...
import com.angrychimps.citizenvet.adapters.animators.AnimationUtils;
import com.angrychimps.citizenvet.adapters.viewholders.AdDetailHeaderViewHolder;
import com.angrychimps.citizenvet.adapters.viewholders.DealGridViewHolder;
import com.angrychimps.citizenvet.adapters.viewholders.MapCardViewHolder;
import com.angrychimps.citizenvet.adapters.viewholders.ServiceItemViewHolder;
...
//    }
    ...
    private void bind(DealGridViewHolder vh, int position) {
        vh.imageCompanyMain.setImageUrl(App.MEDIA_URL + deals.get(position).getPhoto(), imageLoader);

...
public interface MessageAPI {
    ...
    @POST("/message") void post(@Body MessageSend message, Callback callback);

    @DELETE("/message/{id}") void delete(@Path("id") String messageId, Callback callback);

    @PATCH("/message") void patch(@Body MessageStatus message, Callback callback);
}
